...
INSERT INTO public.flag (id, name, field_value, datatype, operator, date_created, created_by, date_modified, modified_by, archived, field_name, continuous) OVERRIDING SYSTEM VALUE VALUES (15, 'Age equal or greater than  15', '15', 0, 'greater_than_or_equal_to', '2021-08-10 13:55:47.537', 'guest@lamisplus.org', '2021-08-11 18:44:14.283', 'guest@lamisplus.org', 0, 'age', true);
