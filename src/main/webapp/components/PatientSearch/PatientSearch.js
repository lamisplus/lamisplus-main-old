              ...
              <Menu>
                ...
                <MenuList style={{ color: "#000 !important" }}>
                  ...
                  <MenuItem style={{ color: "#000 !important" }}>
                    <Link
                      to={
                        "/patient-dashboard?hospitalNumber=" +
                        row.hospitalNumber
                      }
                    >
                      <MdDashboard size="15" color="blue" />{" "}
                      <span style={{ color: "#000" }}>Patient Dashboard</span>
                    </Link>
                  </MenuItem>
                  ...
                  <MenuItem style={{ color: "#000 !important" }}>
                    ...
                    >
                      ...
                      <span style={{ color: "#000" }}>Edit Patient </span>
                    </Link>
                  </MenuItem>
                  <MenuItem style={{ color: "#000 !important" }}>
                    <Link onClick={() => onDelete(row.patientId)}>
