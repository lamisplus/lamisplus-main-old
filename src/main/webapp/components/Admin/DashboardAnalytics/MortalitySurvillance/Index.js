...
import Sex from './DashBoardVisualisation/Sex';
  ...
  return (
    <div  spacing={3} style={{ padding: 10 }} >
     <Breadcrumbs aria-label="breadcrumb">
       ...
       <Typography color="textPrimary"> <h3>Mortality Surveillance</h3> </Typography>
     </Breadcrumbs>
     <br/>
      <Row>
        <Col md={3}>
        ...
        <Col md={9}>
          {/* The second Column Card Layout  */}
            <Row>
                ...
                <Col  lg={12} md={12} sm={12} xs={12} >
                  <Alert color="info">
                    The MS section of the NDR is under active development. Some charts contains sample data
                  </Alert>
                </Col>
