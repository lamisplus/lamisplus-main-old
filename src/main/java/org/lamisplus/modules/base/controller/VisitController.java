...
public class VisitController {
    ...
    @GetMapping("/totalCount/{visitTypeId}")
    public ResponseEntity<Integer> getTotalCount(@PathVariable Long visitTypeId) {
        return ResponseEntity.ok(visitService.getVisitType(visitTypeId));
    }
