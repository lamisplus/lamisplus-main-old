...
public class FormController {
    ...
    public ResponseEntity<Form> getFormByFormCode(@PathVariable String formCode, @RequestParam("formType") Optional<Integer> formType) {
            return ResponseEntity.ok(this.formService.getFormByFormCode(formCode, formType));
    }
