...
public interface EncounterRepository extends JpaRepository<Encounter, Long> , JpaSpecificationExecutor {
    ...
    Optional<Encounter> findByPatientIdAndProgramCodeAndFormCodeAndDateEncounterAndOrganisationUnitId(Long patientId, String ProgramCode, String FormCode, LocalDate dateEncounter, Long organisationUnitId);
