package org.lamisplus.modules.base.base.security.jwt;
...
import org.lamisplus.modules.base.base.service.UserService;
...
public class TokenProvider {
    ...
    public String createToken(Authentication authentication, UserService userService, boolean rememberMe) {
        ...
        org.lamisplus.modules.base.base.domain.entity.User user = userService.getUserWithRoles().get();
        //getting & adding user details to token
        String name = user.getPerson().getFirstName() + " " + userService.getUserWithRoles().get().getPerson().getLastName();
